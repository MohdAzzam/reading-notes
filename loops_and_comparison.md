...
    1. `==` it mean is **equal to** it . `5 == 5` the result of this example is `true` this operation it's just to compare a value if you see `5 =='5' ` it will return true also as we said it compare the value
...
    1. `while(CONDITION){//code and COUNTER}`
